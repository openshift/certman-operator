...
//AWSNewClient returns an awsclient.Client object to the caller. If NewClient is passed a non-null
...
func AWSNewClient(kubeClient client.Client, secretName, namespace, region string) (AWSClient, error) {
