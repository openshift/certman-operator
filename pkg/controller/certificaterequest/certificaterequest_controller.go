...
type ReconcileCertificateRequest struct {
	...
	clientBuilder func(kubeClient client.Client, platfromSecret certmanv1alpha1.PlatformSecrets, namespace string, region string) (cClient.Client, error)
}
...
func (r *ReconcileCertificateRequest) getClient(cr *certmanv1alpha1.CertificateRequest) (cClient.Client, error) {
	client, err := r.clientBuilder(r.client, cr.Spec.PlatformSecrets, cr.Namespace, cr.Spec.Region)
	return client, err
}
