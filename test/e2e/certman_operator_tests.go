...
var _ = ginkgo.Describe("Certman Operator", ginkgo.Ordered, func() {
	var (
	...
	ginkgo.BeforeAll(func(ctx context.Context) {
		...
		gomega.Expect(ocmClusterID).ShouldNot(gomega.BeEmpty(), "OCM_CLUSTER_ID environment variable must be set")
	...
	ginkgo.Context("Certificate Request Workflow Integration Tests", ginkgo.ContinueOnFailure, func() {
