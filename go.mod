...
require (
	...
	github.com/openshift/osde2e v0.0.0-20240722194944-c3399dd618e5
...
replace (
	k8s.io/api v0.29.0 => k8s.io/api v0.26.3
	k8s.io/apimachinery v0.29.0 => k8s.io/apimachinery v0.26.3
	k8s.io/client-go v0.29.0 => k8s.io/client-go v0.26.3
	k8s.io/kube-openapi v0.0.0-20231010175941-2dd684a91f00 => k8s.io/kube-openapi v0.0.0-20230327201221-f5883ff37f0c
	sigs.k8s.io/controller-runtime v0.16.3 => sigs.k8s.io/controller-runtime v0.14.6
)
